        ...
        <div className="w-full mt-1 p-3.5 bg-neutral-950/80 border border-neutral-800 rounded-lg text-left transition-all animate-in fade-in duration-200">
          <div className="flex items-center justify-between text-xs text-neutral-400 mb-1">
            <span className="inline-flex items-center gap-1 text-emerald-400 font-medium">
              <CheckCircle2 className="w-3 h-3" /> Hostel found
            </span>
            <span className="font-mono text-neutral-500">{matchedHostel.code}</span>
          </div>
          ...
          <button
            type="submit"
            className="w-full mt-3 py-2 px-4 bg-white text-black hover:bg-neutral-200 rounded-md font-medium text-xs tracking-wide transition-colors flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
          >
